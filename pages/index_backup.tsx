...
/*
import lib ต่างๆรวมถึง components และ models
*/
...
*/
  ...
  /*
  ใช้ useEffect ดึงข้อมูลจาก local storange 
  */
  ...
  /* สร้าง addNewTodo เพื่อรองรับข้อมูล event สู่ฟอร์ม */
  ...
  /* รับ event ต่างๆส่งให้ onDragEnd ใน bDnD */
